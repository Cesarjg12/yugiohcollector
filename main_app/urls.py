...
urlpatterns = [
    ...
    path('cats/<int:yugioh_card_id>/assoc_deck/<int:deck_id>/', views.assoc_deck, name='assoc_deck'),
    path('cats/<int:yugioh_card_id>/unassoc_deck/<int:deck_id>/', views.unassoc_deck, name='unassoc_deck'),
